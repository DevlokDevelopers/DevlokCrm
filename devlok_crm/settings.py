...
ALLOWED_HOSTS = ["crmdevlok-production.up.railway.app","devlokcrmbackend.up.railway.app","crm-devlok.vercel.app"]  # Set specific Railway domain in production for security

DATABASES_URL = "postgresql://postgres:pCcVtZTXRHjWnkAIQWnrtRoENnDHJRmb@yamanote.proxy.rlwy.net:33209/railway"
